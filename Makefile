...
RELEASE_EXES=$(BA_EXE) $(BARBELL_EXE) $(COMPLETE_EXE) $(CYCLE_EXE) $(EMPTY_EXE) $(ER_EXE) $(PATHGRAPH_EXE) $(RINGLATTICE_EXE)
DEBUG_EXES=$(BA_DEBUG_EXE) $(BARBELL_DEBUG_EXE) $(COMPLETE_DEBUG_EXE) $(CYCLE_DEBUG_EXE) $(EMPTY_DEBUG_EXE) $(ER_DEBUG_EXE) $(PATHGRAPH_DEBUG_EXE) $(RINGLATTICE_DEBUG_EXE)
all: $(RELEASE_EXES)
debug: $(DEBUG_EXES)
